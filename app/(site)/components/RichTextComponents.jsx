...
export const RichTextComponents = {
  ...
  marks: {
    strong: ({ children }) => (
      <strong className="font-normal dark-text-primary">{children}</strong>
    ),
  },

  block: {
    h1: ({ children }) => (
      <h1 className="text-lg font-semibold tracking-wide dark-text-primary mt-6 mb-3">
        {children}
      </h1>
    ),
    h2: ({ children }) => (
      <h2 className="text-lg font-semibold tracking-wide dark-text-primary mt-5 mb-3">
        {children}
      </h2>
    ),
